# Python file containing objects that hold features of a few tweets that we can run
...
example1 = {
        "created_at":time.mktime(datetime.datetime.strptime("Tue Oct 14 23:59:56 +0000 2014",'%a %b %d %H:%M:%S +0000 %Y').timetuple()),
...
example2 = {
        "created_at":time.mktime(datetime.datetime.strptime("Tue Oct 14 23:59:51 +0000 2014",'%a %b %d %H:%M:%S +0000 %Y').timetuple()),
...
example5 = {
        "created_at":time.mktime(datetime.datetime.strptime("Tue Oct 14 23:59:48 +0000 2014",'%a %b %d %H:%M:%S +0000 %Y').timetuple()),
...
example8 = {
        "created_at":time.mktime(datetime.datetime.strptime("Tue Oct 14 23:59:45 +0000 2014",'%a %b %d %H:%M:%S +0000 %Y').timetuple()),
